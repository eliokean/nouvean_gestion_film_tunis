    ...
    <div className="min-h-screen bg-gradient-to-br from-red-600 via-red-700 to-red-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-600 focus:border-transparent transition"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center cursor-pointer group">
                  ...
                  />
                  <span className="ml-2 text-gray-700 group-hover:text-gray-900 transition">
                    Se souvenir de moi
                  </span>
                </label>
                <a
          ...
          <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
            <div className="flex items-center justify-center gap-4 text-xs text-gray-500">
              <a href="/aide" className="hover:text-gray-700 transition">Centre d'aide</a>
              <span>•</span>
              <a href="/confidentialite" className="hover:text-gray-700 transition">Confidentialité</a>
              <span>•</span>
              <a href="/conditions" className="hover:text-gray-700 transition">Conditions</a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-center">
          <div className="inline-flex items-center gap-2 text-red-100 text-sm bg-white bg-opacity-20 px-4 py-2 rounded-full backdrop-blur-sm">
        ...
        <p className="text-center text-red-100 text-xs mt-4">
          © 2024 Doc à Tunis. Tous droits réservés.
        </p>
      </div>
    </div>
  );
